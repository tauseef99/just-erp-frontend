...
const SellerDashboard = () => {
  ...
  const fetchProfileImage = async () => {
    try {
      ...
      const response = await axios.get('${process.env.REACT_APP_API_URL}/api/seller/profile', {
        headers: { 
  ...
  return (
    <SellerLayout>
      <div className="flex bg-gray-50 min-h-screen p-6">
        ...
        <img
          src={profileImage ? `${process.env.REACT_APP_API_URL}/uploads/${profileImage}` : "https://static.vecteezy.com/system/resources/thumbnails/005/346/410/small_2x/close-up-portrait-of-smiling-handsome-young-caucasian-man-face-looking-at-camera-on-isolated-light-gray-studio-background-photo.jpg"}
          alt="Profile"
